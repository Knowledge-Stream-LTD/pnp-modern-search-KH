...
import { FilterNumberRangeWebComponent } from "./filters/FilterNumberRangeComponent";
...
export class AvailableComponents {
  ...
  public static BuiltinComponents: IComponentDefinition<any>[] = [
    ...
    {
      componentName: "pnp-filternumberrange",
      componentClass: FilterNumberRangeWebComponent,
    },
  ];
}
